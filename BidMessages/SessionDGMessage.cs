namespace BidMessages
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <c>SessionDGMessage</c> class with the given byte array, start index, and number of bytes.
        /// </summary>
        ...
        public SessionDGMessage(byte[] message, int offset, int count)

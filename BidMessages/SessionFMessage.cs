...
namespace BidMessages
{
    ...
    public class SessionFMessage : SessionCEFHMessage
    {
        ...
        /// <exception cref="System.Exception">Input byte array does not represent a session F message.</exception>
        ...
        /// <summary>
        /// This method gets a string representation for the specified <c>SessionFMessage</c> instance.
        /// </summary>
        /// <returns>A string that contains the message type and update time.</returns>
        public override string ToString()
        {
            return "Session F: " + UpdateTimestamp;
        }
    }
}

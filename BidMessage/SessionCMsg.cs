...
{
    /// <summary>
    /// Class <c>SessionAMsg</c> models <c>QuoteMessage</c>s of Session C.
    /// </summary>
    public class SessionCMsg : SessionCEFHMsg
    {
        /// <summary>
        ...
        public SessionCMsg(byte[] body, int startIndex, int count)

...
{
    /// <summary>
    /// Class <c>SessionAMsg</c> models <c>QuoteMessage</c>s of Session H.
    /// </summary>
    public class SessionHMsg : SessionCEFHMsg
    {
        /// <summary>
        ...
        public SessionHMsg(byte[] body, int startIndex, int count)
